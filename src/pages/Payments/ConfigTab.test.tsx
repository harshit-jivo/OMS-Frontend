...
import type { BankSyncMeta } from "../../services/approvalService";
...
const META: BankSyncMeta = {
  synced_at: "2026-09-05T10:00:00Z",
  stale: false,
  source: "cache",
  bank_count: 1,
  // Both are required on BankSyncMeta and were missing, so this fixture did
  // not typecheck. `available` says SAP answered; `has_errors` is what the
  // card's own "Configuration error" notice is derived from.
  available: true,
  has_errors: false,
};
