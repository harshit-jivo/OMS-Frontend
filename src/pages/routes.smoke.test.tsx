...
const PAGES: Array<SmokeEntry<any>> = [
  ...
  page("/Workflows", () => import("./Workflows")),
  page("/BackDate", () => import("./BackDate")),
  page("/BackDate_Approval", () => import("./BackDate_Approval")),
  page("/Production_Orders", () => import("./Production_Orders")),
  ...
  // Distributor "Order Tracking" reuses the shared View Orders page.
  page("/Distributor_Order_Tracking", () => import("./View_Orders")),
  page("/Mart_Approval", () => import("./Distributor/Mart_Approval")),
  page("/Mart_Edit_Order", () => import("./Distributor/Edit_Order")),
  page("/Mart_Cancel", () => import("./Distributor/Mart_Cancel")),
  ...
  page("/Distributor_Report", () => import("./Distributor_Report")),
